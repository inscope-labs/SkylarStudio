...
class LaneAServer(
    ...
    private fun mapErrorCodeToHttpStatus(errorCode: String): Int = when (errorCode) {
        ...
        "VERIFY_EXPIRED", "ENVELOPE_EXPIRED", "VERIFY_REPLAY_DETECTED", "REPLAY_DETECTED",
        "VERIFY_INVALID_SIGNATURE", "INVALID_SIGNATURE", "INVALID_WORKFLOW_HASH", "UNKNOWN_CALLER", "MALFORMED_SIGNATURE" -> 403
    ...
    private fun mapErrorCodeToStatusString(errorCode: String): String = when (errorCode) {
        ...
        "VERIFY_INVALID_SIGNATURE", "INVALID_SIGNATURE", "INVALID_WORKFLOW_HASH", "UNKNOWN_CALLER", "MALFORMED_SIGNATURE" -> LaneAResponse.STATUS_UNAUTHORIZED
